  ...
  <div class="wizard">
    ...
    <div class="wizard__body">
      ...
      <div class="wizard__body__actions clearfix">
        <a v-if="backEnabled" class="wizard__back pull-left" @click="goBack()"> <img src="/public/images/vendor/vue-good-wizard/back.png" alt="next icon"> <span>Назад</span>
        </a>
        <a v-if="currentStep != steps.length - 1" class="wizard__next pull-right" @click="goNext()">
          <span>Далее</span> <img src="/public/images/vendor/vue-good-wizard/next.png" alt="next icon">
        </a>
...
<script>
    export default {
        ...
        props: {
            steps: {},
            finalStepLabel: {default: 'Создать'},
            onNext: {},
            onBack: {},
            stepProp: 0,
        },
        ...
        computed: {
            ...
            currentStep: {
                get() { return this.$store.state.wizardCurrentStep },
                set(value) { return this.$store.state.wizardCurrentStep = value }
            }
        },
        methods: {
            goNext (skipFunction) {
